...
lines = pd.read_csv('data\commentary.csv')
...
def detailed_sim_goal(settings, minute, min_score, score, player_df, home, home_players, home_atk, home_pass, away, away_players, away_atk, away_pass,
